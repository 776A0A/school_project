			...
			<div class="layui-layout layui-layout-admin">
				<div class="layui-header">
					...
					<ul class="layui-nav layui-layout-left">
						...
						<li class="layui-nav-item" lay-unselect><a href=""
							title="刷新"> <i
				...
				<div class="layui-side layui-side-menu">
					<div class="layui-side-scroll">
						<div class="layui-logo" lay-href="src/views/roleList.jsp">
							<span>学校后台管理</span>
						</div>
							...
							<li data-name="home" class="layui-nav-item layui-nav-itemed">
								...
								<dl class="layui-nav-child">
									<dd data-name="console" class="layui-this">
										<a
											lay-href="${pageContext.request.contextPath }/src/views/students.jsp">学生管理</a>
									</dd>
									<dd data-name="console">
										<a
											lay-href="${pageContext.request.contextPath }/src/views/classes.jsp">班级管理</a>
									</dd>
									<dd data-name="console">
										<a
											lay-href="${pageContext.request.contextPath }/src/views/results.jsp">成绩管理</a>
									</dd>
								</dl>
							</li>
						</ul>
				...
				<div class="layui-body" id="LAY_app_body">
					<div class="layadmin-tabsbody-item layui-show">
						<iframe
							src="${pageContext.request.contextPath }/src/views/students.jsp"
